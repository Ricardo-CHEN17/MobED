...
: ${AMENT_CURRENT_PREFIX:="/workspace/mobed_ws/install/robot_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_control/environment/library_path.sh"
